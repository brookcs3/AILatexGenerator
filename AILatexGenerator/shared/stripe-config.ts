...
export const STRIPE_PRICE_IDS = {
  ...
  [SubscriptionTier.Pro]: process.env.STRIPE_PRICE_TIER3_ID || '',   // $6.99/month (Pro Plan)
  [SubscriptionTier.Tier4]: 'price_1RQTn0FlLCnouIYKOMOghgIp', // $11.99/month (Advanced Plan) - Tax inclusive
