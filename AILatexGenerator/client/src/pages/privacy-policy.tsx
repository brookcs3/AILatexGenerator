        ...
        <AnimatedSection delay={0.3} className="mb-12">
          <GlassCard>
            <p className="text-lg leading-relaxed">
              Welcome to AI LaTeX Generator ("we," "our," or "us"). We respect
        ...
        <div className="space-y-8">
            ...
            <AnimatedSection>
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-8">
                {[
                  {
                    title: "Identity Data",
                    description: "Email address and username",
                  },
                  {
                  ...
                  {
                    title: "LaTeX Generation Data",
                    description:
                      "Input content you provide and the LaTeX content generated",
                  },
                ].map((item, i) => (
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <AnimatedSection>
                <div
                  className="h-full p-6 rounded-xl relative overflow-hidden
                  transition-all duration-300 cursor-default
                  bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm
                  shadow-md border border-gray-100/80 dark:border-gray-700/80 
                  hover:shadow-lg hover:translate-y-[-3px] 
            ...
            <AnimatedSection>
              <GlassCard className="mb-8">
                <p className="text-gray-700 dark:text-gray-300 mb-6">
                  We use third-party services that may collect information used
                  to identify you. These include:
                </p>
                <div className="space-y-4">
                  {[
                    ...
                    },
                    {
                      ...
                      description:
                        "We use external AI services to generate LaTeX documents. These providers have access to the content you submit for generation.",
                    },
                    {
                      title: "Analytics",
                      description:
                        "We use analytics to track usage of our service.",
                    },
                    {
                      title: "Advertising",
                      description:
            ...
            <AnimatedSection>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  ...
                  <AnimatedSection key={i} delay={0.05 * i}>
                    <div
                      className="p-4 h-full rounded-lg flex items-center
                      transition-all duration-300 
            ...
            <AnimatedSection>
              <div className="rounded-2xl overflow-hidden bg-gradient-to-r from-blue-500 to-cyan-500 p-[2px]">
                <div className="bg-white/90 dark:bg-gray-900/90 rounded-2xl p-8 relative overflow-hidden backdrop-blur-sm">
                  <h3 className="text-2xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-500">
                    Contact Us
                  </h3>
