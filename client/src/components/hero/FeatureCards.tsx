...
export default function FeatureCards() {
  return (
    <div className="features-container flex justify-center flex-wrap gap-8 mt-12 w-full">
      <div className="feature-card bg-white/90 backdrop-blur-lg rounded-2xl p-8 w-full max-w-[350px] transition-all border border-blue-500/20 shadow-md hover:-translate-y-2 hover:border-blue-500/60 hover:shadow-lg">
        <div className="feature-icon bg-gradient-to-br from-blue-500 to-indigo-500 w-[60px] h-[60px] rounded-xl flex items-center justify-center mb-6">
          <svg
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
